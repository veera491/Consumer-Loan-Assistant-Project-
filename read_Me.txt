...
public class LoanAssistant extends JFrame {
      ...
      JButton paymentButton,computeButton, monthsButton,newLoanButton,exitButton;
      JTextField monthsTextField,paymentTextField,balanceTextField,interestTextField;
    ...
    public LoanAssistant() {
        ...
        gridConstraints = new GridBagConstraints(); gridConstraints.gridx = 3;
        gridConstraints.gridy = 5;
    ...
    private void computeButtonActionPerformed(ActionEvent e) {
        double balance, interest, payment; int months;
